...
def q_sample(x_start, t, noise=None):
    ...
    sqrt_alphas_cumprod_t = extract(params.sqrt_alphas_cumprod, t, x_start.shape)
    sqrt_one_minus_alphas_cumprod_t = extract(
        params.sqrt_one_minus_alphas_cumprod, t, x_start.shape
    )
...
def p_sample(model, x, t, t_index):
    ...
    sqrt_one_minus_alphas_cumprod_t = extract(
        params.sqrt_one_minus_alphas_cumprod, t, x.shape
    )
